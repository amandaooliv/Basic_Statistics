...
# Tarefa 3 - Construir um gráfico mostrando a relação de duas variáveis numéricas s para as 3 categorias de uma variável categórica.
library(ggplot2)
...
# Cores disponíveiss na Linguagem R
colors()
